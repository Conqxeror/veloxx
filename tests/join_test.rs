...
fn test_inner_join() {
    ...
    columns1.insert("id".to_string(), Series::new_i32("id", vec![Some(1), Some(2), Some(3)]));
    columns1.insert("name".to_string(), Series::new_string("name", vec![
    ...
    columns2.insert("id".to_string(), Series::new_i32("id", vec![Some(1), Some(2), Some(4)]));
    columns2.insert("age".to_string(), Series::new_i32("age", vec![Some(25), Some(30), Some(35)]));
...
fn test_left_join() {
    ...
    // Create second DataFrame
    let mut columns2 = BTreeMap::new();
    columns2.insert("id".to_string(), Series::new_i32("id", vec![Some(1), Some(2)]));
    columns2.insert("age".to_string(), Series::new_i32("age", vec![Some(25), Some(30)]));
    let df2 = DataFrame::new(columns2).unwrap();
...
fn test_right_join() {
    // Create first DataFrame
    let mut columns1 = BTreeMap::new();
    columns1.insert("id".to_string(), Series::new_i32("id", vec![Some(1), Some(2)]));
    columns1.insert("name".to_string(), Series::new_string("name", vec![
        Some("Alice".to_string()), 
        Some("Bob".to_string())
    ]));
    ...
    // Create second DataFrame
    let mut columns2 = BTreeMap::new();
    columns2.insert("id".to_string(), Series::new_i32("id", vec![Some(1), Some(2), Some(3)]));
    columns2.insert("age".to_string(), Series::new_i32("age", vec![Some(25), Some(30), Some(35)]));
    let df2 = DataFrame::new(columns2).unwrap();
...
fn test_join_with_no_matches() {
    ...
    let mut columns2 = BTreeMap::new();
    columns2.insert("id".to_string(), Series::new_i32("id", vec![Some(3), Some(4)]));
    columns2.insert("age".to_string(), Series::new_i32("age", vec![Some(25), Some(30)]));
    let df2 = DataFrame::new(columns2).unwrap();
...
fn test_join_with_nulls() {
    ...
    let mut columns1 = BTreeMap::new();
    columns1.insert("id".to_string(), Series::new_i32("id", vec![Some(1), None, Some(3)]));
    columns1.insert("name".to_string(), Series::new_string("name", vec![
        Some("Alice".to_string()), 
        Some("Bob".to_string()), 
        Some("Charlie".to_string())
    ...
    // Create second DataFrame
    let mut columns2 = BTreeMap::new();
    columns2.insert("id".to_string(), Series::new_i32("id", vec![Some(1), Some(3)]));
    columns2.insert("age".to_string(), Series::new_i32("age", vec![Some(25), Some(35)]));
    let df2 = DataFrame::new(columns2).unwrap();
