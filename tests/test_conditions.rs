...
fn test_and_condition() {
    let condition = Condition::And(Box::new(Condition::Eq("col1".to_string(), Value::I32(10))), Box::new(Condition::Gt("col2".to_string(), Value::F64(5.0))));
    assert_eq!(
        format!("{:?}", condition),
...
fn test_or_condition() {
    let condition = Condition::Or(Box::new(Condition::Eq("col1".to_string(), Value::I32(10))), Box::new(Condition::Lt("col2".to_string(), Value::F64(5.0))));
    assert_eq!(
        format!("{:?}", condition),
