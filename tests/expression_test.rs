...
fn test_expression_evaluation() {
    ...
    columns.insert("age".to_string(), Series::new_i32("age", vec![Some(25), Some(30), Some(35)]));
    columns.insert("score".to_string(), Series::new_f64("score", vec![Some(85.5), Some(92.0), Some(78.5)]));
...
fn test_arithmetic_expression_evaluation() {
    let mut columns = BTreeMap::new();
    columns.insert("a".to_string(), Series::new_i32("a", vec![Some(10), Some(20)]));
    columns.insert("b".to_string(), Series::new_i32("b", vec![Some(5), Some(3)]));
    let df = DataFrame::new(columns).unwrap();
