Search.setIndex({
  docnames: ["api", "index"],
  filenames: ["api.rst", "index.rst"],
  titles: ["Python API Reference", "&lt;no title&gt;"],
  terms: { python: 1, api: 1, refer: 1 },
  objects: { "": [[0, 0, 0, "-", "veloxx"]] },
  objtypes: { 0: "py:module" },
  objnames: { 0: ["py", "module", "Python module"] },
  titleterms: { python: 0, api: 0, refer: 0, content: 1 },
  envversion: {
    "sphinx.domains.c": 2,
  ...
  alltitles: {
    "Python API Reference": [[0, "module-veloxx"]],
    "Contents:": [[1, null]],
  },
  indexentries: {
    module: [[0, "module-veloxx"]],
    veloxx: [[0, "module-veloxx"]],
  },
});
