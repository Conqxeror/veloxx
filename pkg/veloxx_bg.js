...
const WasmDataFrameFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_wasmdataframe_free(ptr >>> 0, 1),
      );
...
export class WasmDataFrame {
  ...
  renameColumn(old_name, new_name) {
    ...
    const ret = wasm.wasmdataframe_renameColumn(
      this.__wbg_ptr,
      ptr0,
      len0,
      ptr1,
...
const WasmSeriesFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_wasmseries_free(ptr >>> 0, 1),
      );
...
const WasmValueFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_wasmvalue_free(ptr >>> 0, 1),
      );
